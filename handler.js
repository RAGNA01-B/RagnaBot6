...
//this.reply(m.chat, `🐈 NO TIENE RAGNACOINS`, m)
this.sendMessage(m.chat, {text: `🐈 NO TIENE RAGNACOINS`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' RagnaBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' RAGNACOINS 🐱 GASTADOS(S)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
"mediaType": 1, 
sourceUrl: 'https://chat.whatsapp.com/KtXIoE1BLOjFk3ejE8MzpV' }}}, { quoted: fkontak2 })
apii.data = ''
